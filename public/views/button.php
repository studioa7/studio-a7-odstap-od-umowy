...
$button_label = esc_html( get_option( 'a7w_button_label', __( 'Odstąp od umowy', 'studio-a7-odstap' ) ) );
...
<section class="a7w-withdrawal-section" id="a7w-section-<?php echo esc_attr( $order->get_id() ); ?>">
	<div class="a7w-withdrawal-box a7w-withdrawal-box--active">
		...
		<button
			type="button"
			class="a7w-btn a7w-btn--primary a7w-open-modal"
...
elseif ( is_wp_error( $can_withdraw ) ) :
	...
	<section class="a7w-withdrawal-section">
		<div class="a7w-withdrawal-box a7w-withdrawal-box--<?php echo 'already_withdrawn' === $error_code ? 'done' : 'expired'; ?>">
			<div class="a7w-withdrawal-icon">
